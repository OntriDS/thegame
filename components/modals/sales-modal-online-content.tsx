...
import { ListPlus, Globe } from 'lucide-react';
import {
  ModalToggleTooltip,
  MODAL_TOGGLE_TOOLTIP_COPY,
} from '@/components/ui/modal-toggle-tooltip';

export type SalesModalOnlineContentProps = Pick<
...
export default function SalesModalOnlineContent({
  saleDate,
  setSaleDate,
  emissaryColumnExpanded,
  showAdvanced,
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col overflow-hidden border-b border-border/80">
      <div className="bg-primary/10 px-6 py-2 border-b border-primary/20 flex items-center gap-2">
        ...
        <span className="text-xs font-medium text-primary tracking-wide uppercase">Akiles Ecosystem Web Order</span>
      </div>
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-4 gap-2">
                      <div>
                        <Label htmlFor="online-reward-xp" className="text-xs">XP</Label>
                        <NumericInput
                          id="online-reward-xp"
                      ...
                      <div>
                        <Label htmlFor="online-reward-rp" className="text-xs">RP</Label>
                        <NumericInput
                          id="online-reward-rp"
                      ...
                      <div>
                        <Label htmlFor="online-reward-fp" className="text-xs">FP</Label>
                        <NumericInput
                          id="online-reward-fp"
                      ...
                      <div>
                        <Label htmlFor="online-reward-hp" className="text-xs">HP</Label>
                        <NumericInput
                          id="online-reward-hp"
          ...
          {showAdvanced && (
            <div className="mt-4 space-y-4">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="description" className="text-xs">Description / Shipping Notes</Label>
                  <Textarea
                    id="description"
                    value={description}
                    onChange={(e) => setDescription(e.target.value)}
                    placeholder="Use this field for shipping details, tracking numbers, or internal notes..."
