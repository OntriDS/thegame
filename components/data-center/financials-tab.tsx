...
export function FinancialsTab({ financialsLog, onReload, isReloading }: FinancialsTabProps) {
  ...
  // The "Sale Log" is the place for the "Net Profit" view.
  const finalDisplayEntries = visibleEntries;
            ...
            <CardContent>
              <div className="space-y-2">
                {finalDisplayEntries.length === 0 ? (
                  ...
                  finalDisplayEntries.map((entry: any, index: number) => {
                          ...
                          <Button
                            ...
                            onClick={async () => {
                              try {
                                ...
                                // Always fetch links for the financial record entity
                                const entityId = entry.entityId;
                                const links = await ClientAPI.getLinksFor({ type: EntityType.FINANCIAL, id: entityId });
