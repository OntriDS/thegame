...
/**
 * Update fields on one log row and persist via `relocateLogEntryToCorrectMonth`.
 * Does **not** append a new list element; relocate removes every same-`id` row in the month
 * bucket then writes a single updated row (and moves month if timestamp changed).
 */
