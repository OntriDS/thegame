...
import { Network, Target, Trophy, CheckSquare, Layers, Goal, Star, Zap } from 'lucide-react';
...
export const DATE_FORMAT_DAY_MONTH_YEAR = 'dd-MM-yy'; // Day-month-year format: 25-12-24 (for recurrent instance names)
